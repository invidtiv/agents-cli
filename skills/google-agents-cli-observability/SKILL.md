...
description: >
  ...
  "configure logging", "add observability", "debug production traffic",
  or needs guidance on monitoring deployed ADK agents.
...
> Cloud Trace and prompt-response logging are pre-configured by Terraform. See `references/cloud-trace-and-logging.md` for infrastructure details, env vars, and verification commands. If your project isn't scaffolded yet, see `/google-agents-cli-scaffold` first.
